...
public class HelloController {
    ...
    private double currentLength = 1.0;
    ...
    public void initialize() {
        ...
        // Initialize other components, such as setting up canvas size and tracking mouse movement
        updateLabel();
        ...
        // Add a listener to the Scene to setup shortcuts
    ...
    @FXML
    private ToggleButton pencilButton, eraserButton, lineButton, rectangleButton, ellipseButton, circleButton, triangleButton, starButton;
    ...
    private void setButtonIcons() {
        ...
        Image lineIcon = new Image(getClass().getResourceAsStream("/images/line_icon.png"));
        Image rectangleIcon = new Image(getClass().getResourceAsStream("/images/rectangle_icon.png"));
        Image ellipseIcon = new Image(getClass().getResourceAsStream("/images/ellipse_icon.png"));
        Image circleIcon = new Image(getClass().getResourceAsStream("/images/circle_icon.png"));
        Image triangleIcon = new Image(getClass().getResourceAsStream("/images/triangle_icon.png"));
        Image eraserIcon = new Image(getClass().getResourceAsStream("/images/eraser_icon.png"));
        Image starIcon = new Image(getClass().getResourceAsStream("/images/star_icon.png"));
    ...
    protected void setCustomSizeCanvas() {
        // Load the icon image
        Image icon = new Image(getClass().getResourceAsStream("/images/paint-P-Logo.png"));
